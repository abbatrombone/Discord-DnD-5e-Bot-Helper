...
public class Listeners extends ListenerAdapter{
    ...
    //This adds and updates the commands as well as what parameters to look for.
        event.getJDA().updateCommands().addCommands(
                ...
                Commands.slash("help","lists all commands"),
                Commands.slash("helpmusic","lists all music commands"),
                Commands.slash("vc","adds bot to voice channel"),
                Commands.slash("addsong","Adds a song"),
                Commands.slash("skip","skips current song"),
                Commands.slash("pause","pauses song"),
                Commands.slash("resume","Resumes song"),
                Commands.slash("nowplaying","info for current song"),
                Commands.slash("leave","leaves vc for the guild"),
                Commands.slash("queuelist","list of current songs"),
                Commands.slash("clearqueue","clears music queue")
